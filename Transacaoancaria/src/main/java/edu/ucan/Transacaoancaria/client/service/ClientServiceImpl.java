   ...
   //"http://localhost:8081/api/v1/transacao/dados?numConta=99999999"
    public ClienteResponse findbyCliente(Integer numConta)
    {
        try {
            ...
            ResponseEntity<ClienteResponse> responseEntity = restTemplate.exchange("http://localhost:8080/api/v1/transacao/dados?numConta="+numConta, HttpMethod.GET, httpEntity, ClienteResponse.class);
    ...
    public void atualizarSaldoCliente(Integer numConta, double saldo)
    {
        try {
            ...
            HttpEntity<String> httpEntity = new HttpEntity<>(null);
            ResponseEntity<String> responseEntity = restTemplate.exchange("http://localhost:8080/api/v1/transacao/actualizar_saldo_Conta?numConta="+numConta+"&valor_conta="+saldo, HttpMethod.GET, httpEntity, String.class);
            if (responseEntity.getBody() == null) {
                throw new Exception();
            }
        } catch (Exception e) {
    ...
    public void atualizarSaldoBeneficiario(Integer numConta, double saldo)
    {
        try {
            ...
            HttpEntity<String> httpEntity = new HttpEntity<>(null);
            ResponseEntity<String> responseEntity = restTemplate.exchange("http://172.20.10.2:8081/api/v1/transacao/atualizar-saldo?numConta="+numConta+"&saldoTotal="+saldo, HttpMethod.GET, httpEntity, String.class);
            if (responseEntity.getBody() == null) {
                throw new Exception();
            }
        } catch (Exception e) {
    ...
    public ClienteResponse findbyBeneficiario(Integer numConta)
    {
        try {
            ...
            HttpEntity<String> httpEntity = new HttpEntity<>(null);
            ResponseEntity<ClienteResponse> responseEntity = restTemplate.exchange("http://172.20.10.2:8081/api/v1/transacao/dados?numConta="+numConta, HttpMethod.GET, httpEntity, ClienteResponse.class);
            if (responseEntity.getBody() == null) {
                throw new Exception();
            }
            return responseEntity.getBody();
